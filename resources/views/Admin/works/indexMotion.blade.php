...
text-align: right;" >
    ...
    <div class="container">
        ...
        @foreach ($works as $work)
            ...
            <video class="bd-placeholder-img card-img-top" alt="" class="bd-placeholder-img card-img-top" width="100%" height="225px" poster="{{ asset('storage/' . $work->poster) }}" controls><source src="{{ asset('storage/' . $work->path) }}"  type="video/mp4"> </video>
